...
<div class="manners-wrapper">
  ...
  <div class="main-contents" id="base-not">
    <div class="area-about">
      <h2 class="page-title">公益社団法人 全国経理教育協会監修</h2>

      <section class="section">
        <div class="container">
          <div class="columns">
            <div class="column is-8 is-offset-2">
              <h3 class="about-title">全国経理教育協会とは</h3>
              <p class="mb3rem">
                昭和32年文部科学省認可として設立。社会人常識マナー検定試験、簿記能力検定試験をはじめ、
                経理、税務の教育に関する検定開催と研究調査を行っています。
              </p>

              <h3 class="about-title">社会人常識マナー検定とは</h3>
              <p class="mb3rem">
                社会人常識マナー検定は、社会人として必要な知識やマナーの習得を促す検定です。
                ビジネスマナーの基本である適切な言葉遣い、動作、たしなみを身に付けることで、
                仕事を円滑に進め、周囲の人々に良い印象を与えることができます。
              </p>
            </div>
          </div>
          ...
          <div class="columns">
            <div class="column is-10 is-offset-1">
              <h3 class="about-3point-title">3つの領域</h3>
              <div class="about-3point">
                <dl>
                  <dt>社会常識</dt>
                  <dd>現代社会・組織に生きる一人の大人として必要な常識や心構え</dd>
                </dl>
                <dl>
                  <dt>コミュニケーション</dt>
                  <dd>ビジネスでのよい人間関係を築くための意思伝達スキル</dd>
                </dl>
                <dl>
                  <dt>ビジネスマナー</dt>
                  <dd>来客応対・電話応対・冠婚葬祭など業務に必要なマナー・技能</dd>
                </dl>
              </div>

              <p class="has-text-centered">
                社会人常識マナー検定についての詳しい内容は、下記ホームページをご覧ください<br>
                <a href="https://www.zenkei.or.jp/exam/commonsense" target="_blank" rel="noopener">
                  https://www.zenkei.or.jp/exam/commonsense
                </a>
              </p>
            </div>
          </div>
