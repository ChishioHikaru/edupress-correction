<?php
/*
Template Name: お問い合わせ／お申し込み／無料体験（社会人常識マナー eラーニング）
*/
get_header();
?>
      ...
      <nav class="navbar">
        <div id="navMenu" class="navbar-menu">
          <div class="navbar-center">
            ...
            <a href="<?php echo home_url('/manners/csm/contacts/'); ?>" class="navbar-item active">お問い合わせ／お申し込み／無料体験</a>
          </div>
        </div>
      </nav>
    </div>
          ...
          <div class="columns">
            <div class="column is-8 is-offset-2">
              ...
              <ul class="contacts-list">
                ...
                <li>上記以外のお取り扱い事項として「<a href="https://www.edupress.co.jp/privacy-policy" target="_blank" rel="noopener">個人情報の取り扱いについて</a>」をご覧下さい。</li>
              </ul>

              <ul class="is-button-area3" style="justify-content: center">
                <li>
                  <a class="button is-contact2" href="<?php echo home_url('/form/csm-inquiry/'); ?>">お問い合わせはこちら</a>
                </li>
                <!-- <li><a class="button is-contact2" href="mailto:...">お問い合わせはこちら</a></li> -->
                <!-- <li><a class="button is-contact2" href="https://edupress.net/manners/csm/application/">お申し込み（個人の方）</a></li> -->
                <li>
                  <a class="button is-contact2" href="<?php echo home_url('/form/csm-application/'); ?>">お申し込み（法人契約の方）<br>こちらからお問い合わせください</a>
                </li>
                <li>
                  <a class="button is-contact2" href="<?php echo home_url('/manners/csm/feature/'); ?>#price">価格はこちら</a>
                </li>
              </ul>

              <div class="is-button-area-ex">
                <a class="button is-experience" href="<?php echo home_url('/form/csm-experience/'); ?>">「無料体験」はこちら</a>
                <p>30日間有効のIDを１IDご利用いただけます</p>
              </div>
