...
<div id="contents">
    ...
    <div class="single__client">
        <div class="single__client--detail">
            <div class="detail_head">
                ...
                <div class="text__wrap">
                    <?php
                        $logo = get_field('cf_client_logo');
                        $service = get_field('cf_client_service');
                        $support = get_field('cf_client_support');
                    ?>
                    <?php if ($logo): ?>
                        <div class="text__wrap--logo">
                            <img src="<?php echo esc_url($logo); ?>" alt="<?php echo get_post_meta(get_the_ID(), 'cf_customer_name', true) ;?>">
                        </div>
                    <?php endif; ?>
                    <p class="name"><?php echo get_post_meta(get_the_ID(), 'cf_customer_name', true) ;?></p>
                    <?php if ($service): ?>
                        <p class="text__wrap--service">サービス：<?php echo esc_html($service); ?></p>
                    <?php endif; ?>
                    <?php if ($support): ?>
                        <p class="text__wrap--support">対応内容：<?php echo esc_html($support); ?></p>
                    <?php endif; ?>
                    <div class="flex_block">
                        <p class="job"><span>業種　</span><?php echo get_post_meta(get_the_ID(), 'cf_customer_job', true) ;?></p>
                        <p class="scale"><span>企業規模　</span><?php echo get_post_meta(get_the_ID(), 'cf_customer_scale', true) ;?></p>
                    </div>
                </div>
                <div class="thumb">
                ...
                <?php
                    $cf_client_lead = get_field('cf_client_lead');
                ?>
                <?php if (!empty($cf_client_lead)): ?>
                    <p class="lead_text"><?php echo nl2br($cf_client_lead); ?></p>
                <?php endif; ?>
            </div>
...
<div class="editor__block">
 ...
        <?php elseif( get_row_layout() == 'table_section' ): ?>
  ...
  <?php endif; ?>
            ...
            <?php
            $item01 = get_post_meta(get_the_ID(), 'cf_client_item01', true);
            $item02 = get_post_meta(get_the_ID(), 'cf_client_item02', true);
            $item03 = get_post_meta(get_the_ID(), 'cf_client_item03', true);

            if ($item01 || $item02 || $item03) : ?>
                <div class="item__wrap">
                    <?php if ($item01) : ?>
                        <div class="item__wrap--block">
                            <div class="block_head">
                                <div class="icon">
                                    <img src="<?php echo home_url('wp-content/themes/edupress/asset/img/client/icon-item01.svg'); ?>" alt="">
                                </div>
                                <p class="title">お客様のお悩み</p>
                            </div>
                            <p class="field_text"><?php echo $item01; ?></p>
                        </div>
                    <?php endif; ?>
                    ...
                    <?php if ($item02) : ?>
                        <div class="item__wrap--block">
                            <div class="block_head">
                                <div class="icon">
                                    <img src="<?php echo home_url('wp-content/themes/edupress/asset/img/client/icon-item02.svg'); ?>" alt="">
                                </div>
                                <p class="title">エデュプレスの解決法</p>
                            </div>
                            <p class="field_text"><?php echo $item02; ?></p>
                        </div>
                    <?php endif; ?>
                    ...
                    <?php if ($item03) : ?>
                        <div class="item__wrap--block">
                            <div class="block_head">
                                <div class="icon">
                                    <img src="<?php echo home_url('wp-content/themes/edupress/asset/img/client/icon-item03.svg'); ?>" alt="">
                                </div>
                                <p class="title">お客様からのお声</p>
                            </div>
                            <p class="field_text"><?php echo $item03; ?></p>
                        </div>
                    <?php endif; ?>
                </div>
            <?php endif; ?>
            ...
            <!-- プロフィール -->
            <?php 
            $client_name = get_post_meta(get_the_ID(), 'cf_client_name', true);
            $client_address = get_post_meta(get_the_ID(), 'cf_client_address', true);
            $client_history = get_post_meta(get_the_ID(), 'cf_client_history', true);
            $client_capital = get_post_meta(get_the_ID(), 'cf_client_capital', true);
            $client_worker = get_post_meta(get_the_ID(), 'cf_client_worker', true);
            $client_summary = get_post_meta(get_the_ID(), 'cf_client_summary', true);
            $client_url = get_post_meta(get_the_ID(), 'cf_client_url', true);
            $logo = get_field('cf_client_logo');

            // いずれかのフィールドに値があるかチェック
            if ($client_name || $client_address || $client_history || $client_capital || $client_worker || $client_summary || $client_url || $logo) : ?>
                <div class="profile__area">
                    <p class="profile__area--title"><span>Client Profile</span></p>
                    <div class="profile__wrap">
                        <?php if ($logo) : ?>
                            <div class="profile__wrap--logo">
                                <img src="<?php echo $logo; ?>" alt="<?php echo $client_name; ?>">
                            </div>
                        <?php endif; ?>

                        <div class="profile__wrap--textarea">
                            <table>
                                <?php if ($client_name) : ?>
                                    <tr>
                                        <th>会社名</th>
                                ...
                                <?php if ($client_history) : ?>
                                    <tr>
                                        <th>設立</th>
                                        <td><?php echo $client_history; ?></td>
                                    </tr>
                                <?php endif; ?>
                                <?php if ($client_capital) : ?>
                                    <tr>
                                        <th>資本金</th>
                                        <td><?php echo $client_capital; ?></td>
                                    </tr>
                                <?php endif; ?>
                                <?php if ($client_worker) : ?>
                                    <tr>
                                        <th>従業員数</th>
                                        <td><?php echo $client_worker; ?></td>
                                    </tr>
                                <?php endif; ?>
                                <?php if ($client_summary) : ?>
                                    <tr>
                                        <th>事業概要</th>
                                        <td><?php echo nl2br($client_summary); ?></td>
                                    </tr>
                                <?php endif; ?>
                                <?php if ($client_url) : ?>
                                    <tr>
                                        <th>URL</th>
                                        <td><a href="<?php echo $client_url; ?>" target="_blank"><?php echo $client_url; ?></a></td>
                                    </tr>
                                <?php endif; ?>
                            </table>
                        </div>
            ...
            <div class="prev_next_link">
                ...
                <a href="<?php echo home_url('client/'); ?>" class="back">事例一覧</a>
                <div class="next_link">
        ...
        <!-- サイドバー -->
        <div class="single__client--sidebar">
            <div class="pickup">
                ...
                <div class="pickup__wrap">
                    ...
                    <a href="<?php the_permalink(); ?>" class="client_box">
                        <div class="thumb">
                            <?php the_post_thumbnail('full'); ?>
                        </div>
                        <div class="textarea">
                            <p class="client_title"><?php the_title(); ?></p>
                        </div>
                    </a>
                    <?php endwhile; ?>
                    <?php else : ?>
