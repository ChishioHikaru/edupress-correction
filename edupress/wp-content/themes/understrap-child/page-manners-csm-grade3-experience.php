<?php
/*
Template Name: 体験サンプル（社会人常識マナー検定3級 eラーニング）
*/
get_header();
?>
...
<div class="manners-wrapper page-experience">
      ...
      <nav class="navbar">
        <div id="navMenu" class="navbar-menu">
          <div class="navbar-center">
            ...
            <a href="<?php echo home_url('/manners/csm-grade3/experience/'); ?>" class="navbar-item active">体験サンプル</a>
            ...
            <div class="column is-12 has-text-centered">
              ...
              <div class="movie-items">
                <dl class="movie-item">
                  ...
                  <dd>
                    <a href="<?php echo get_stylesheet_directory_uri(); ?>/manners/movie/communication.mp4"
                       target="_blank" class="movie-item-btn" rel="noopener">動画はこちら</a>
                  </dd>
                </dl>
                <dl class="movie-item">
                  <dt>ビジネスマナー</dt>
                  ...
                  <dd>
                    <a href="<?php echo get_stylesheet_directory_uri(); ?>/manners/movie/reception.mp4"
                       target="_blank" class="movie-item-btn" rel="noopener">動画はこちら</a>
                  </dd>
                </dl>
                <dl class="movie-item">
                  ...
                  <dd>
                    <a href="<?php echo get_stylesheet_directory_uri(); ?>/manners/movie/knowledge.mp4"
                       target="_blank" class="movie-item-btn" rel="noopener">動画はこちら</a>
                  </dd>
                </dl>
              </div><!-- /.movie-items -->
