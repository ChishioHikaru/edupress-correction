...
function my_meta_ogp() {
    ...
    $insert .= '<meta property="og:image" content="'.home_url('wp-content/themes/edupress/asset/img/common/ogp.png').'" />' . "\n";
...
function my_script_load(){
  ...
  wp_enqueue_script('jquery', 'https://code.jquery.com/jquery-3.3.1.min.js', array());
	...
	wp_enqueue_script('base', home_url('wp-content/themes/edupress/asset/js/common.js'), array());
...
function add_style_sheet(){
  ...
  if ( is_home() || is_front_page() ) :
    wp_enqueue_style('allstyle', home_url('wp-content/themes/understrap-child/asset/css/top/style.css?'.date('Ymd-Hi')));
  elseif (is_404()) :
    wp_enqueue_style('contactstyle', home_url('wp-content/themes/understrap-child/asset/css/other/style.css'));
  else :
    wp_enqueue_style('articlestyle', home_url('wp-content/themes/understrap-child/asset/css/'.$slug.'/style.css?'.date('Ymd-Hi')));
  endif;
}
