<?php
/*
Template Name: 選ばれる企業とマナー（社会人常識マナー検定3級 eラーニング）
*/
get_header();
?>
...
<div class="manners-wrapper">
  ...
  <!-- ▼▼ /manners/csm-grade3/select/index.html のコンテンツ移行部分 ▼▼ -->
          ...
          <div class="columns">
            <div class="column is-10 is-offset-1">
              <div class="select-navi">
                <dl class="genre01">
                  <dt class="select-genre">交通</dt>
                  <dd class="select-name">
                    <a href="<?php echo home_url('/manners/csm-grade3/select/select01/'); ?>" class="stretched-link">
                      JR九州<br>（九州旅客鉄道株式会社）
                    </a>
                  </dd>
                </dl>
                <dl class="genre02">
                  <dt class="select-genre">レジャー</dt>
                  <dd class="select-name">
                    <a href="<?php echo home_url('/manners/csm-grade3/select/select02/'); ?>" class="stretched-link">
                      旭川市旭山動物園
                    </a>
                  </dd>
                </dl>
                <dl class="genre03">
                  <dt class="select-genre">サービス</dt>
                  <dd class="select-name">
                    <a href="<?php echo home_url('/manners/csm-grade3/select/select03/'); ?>" class="stretched-link">
                      株式会社ベアーズ
                    </a>
                  </dd>
                </dl>
                <dl class="genre04">
                  <dt class="select-genre">飲食</dt>
                  <dd class="select-name">
                    <a href="<?php echo home_url('/manners/csm-grade3/select/select04/'); ?>" class="stretched-link">
                      株式会社<br>力の源カンパニー
                    </a>
                  </dd>
                </dl>
                <dl class="genre05">
                  <dt class="select-genre">ホテル・旅館</dt>
                  <dd class="select-name">
                    <a href="<?php echo home_url('/manners/csm-grade3/select/select05/'); ?>" class="stretched-link">
                      指宿白水館
                    </a>
                  </dd>
                </dl>
                <dl class="genre06">
                  <dt class="select-genre">小売り</dt>
                  <dd class="select-name">
                    <a href="<?php echo home_url('/manners/csm-grade3/select/select06/'); ?>" class="stretched-link">
                      株式会社<br>タキダエンタープライズ
                    </a>
                  </dd>
                </dl>
                <dl class="genre07">
                  <dt class="select-genre">福祉</dt>
                  <dd class="select-name">
                    <a href="<?php echo home_url('/manners/csm-grade3/select/select07/'); ?>" class="stretched-link">
                      社会福祉法人<br>こうほうえん
                    </a>
                  </dd>
                </dl>
                <dl class="genre08">
                  <dt class="select-genre">IT</dt>
                  <dd class="select-name">
                    <a href="<?php echo home_url('/manners/csm-grade3/select/select08/'); ?>" class="stretched-link">
                      株式会社エイチーム
                    </a>
                  </dd>
                </dl>
