<?php
/*
Template Name: 体験者の声 夏城らんかさん（社会人常識マナー eラーニング）
*/
get_header();
?>
...
<div class="manners-wrapper">
      ...
      <nav class="navbar">
        <div id="navMenu" class="navbar-menu">
          <div class="navbar-center">
            ...
            <a href="<?php echo home_url('/manners/csm/voice/voice01/'); ?>" class="navbar-item active">体験者の声</a>
  ...
  <div class="main-contents" id="base-not">
    <div class="area-voice">
      <h2 class="page-title">体験者の声</h2>

      <section class="section">
        <h3 class="voice-title-main">
          <span>未来を担う若者を<br>社会に送り出す学校として・・・</span><br>
          マナーやコミュニケーションに思うこと
        </h3>
          ...
          <div class="columns">
            <div class="column is-8 is-offset-2 is-mb2rem">
              <div class="voice-card">
                <h3 class="voice-title-name">東京交通短期大学</h3>

                <div class="columns">
                  <div class="column is-9">
                    <p class="lined-paper">
                      本学は、将来、交通系の仕事に就きたいと考え、入学して来る人がほとんどです。
                      私がマナーやコミュニケーションについてはじめに学生に伝えているのは、
                      「笑顔で明るく、そして大きな声ではっきりと話すことが大切」と言うことです。
                      彼らと毎日のように接する私は、一人ひとりの良さがわかりますが、
                      駅を利用されるお客様は駅員とは一期一会。
                      たとえば駅の構内で道を訪ねるにしても、
                      声が聞こえない、話しかけにくい雰囲気の駅員では困ります。
                      第一印象は大事なので、自然に明るい笑顔で接することができるようになってほしいです。
                      そのために、教えるだけではなく、実践的な講義も心掛けています。
                    </p>
                  </div>

                  <div class="column">
                    <dl class="voice-photoname">
                      <dt>
                        <img src="<?php echo get_stylesheet_directory_uri(); ?>/manners/csm/voice/voice01/img/profile1.jpg" alt="講師写真">
                      </dt>
                      <dd>
                        <span>ビジネスマナー講師</span><br>夏城らんか
                      </dd>
                    </dl>
                  </div>
                </div>

                <h4 class="voice-title-profile">PROFILE</h4>
                <p>
                  東京交通短期大学<br>
                  東京都豊島区池袋本町2-5-15<br>
                  TEL：03-3971-4704
